...
This is the documentation for the external API.
...
export type EventContent =
    | EventContentOneOf
    | EventContentOneOfThree
    | EventContentOneOfFive;
 ...
 */
export type PaginatedSearchResponseItemCursorItemsItemDetails = {
    [key: string]: unknown;
};
 ...
 * 'remove' operation
 */
export type PatchOperationOneOfFour = RemoveOperation &
    PatchOperationOneOfFourAllOf;
 ...
 * 'replace' operation
 */
export type PatchOperationOneOfSeven = ReplaceOperation &
    PatchOperationOneOfSevenAllOf;
 ...
 * 'move' operation
 */
export type PatchOperationOneOfOnezero = MoveOperation &
    PatchOperationOneOfOnezeroAllOf;
 ...
 * 'copy' operation
 */
export type PatchOperationOneOfOnethree = CopyOperation &
    PatchOperationOneOfOnethreeAllOf;
 ...
 * 'test' operation
 */
export type PatchOperationOneOfOnesix = TestOperation &
    PatchOperationOneOfOnesixAllOf;
 ...
 * @summary Like a song
 */
export const queuesLikeSong = <TData = AxiosResponse<void>>(
    queueId: string,
    songId: string,
    options?: AxiosRequestConfig
): Promise<TData> => {
    return axios.post(
        `/api/queues/${queueId}/queue/${songId}/like`,
        undefined,
        options
    );
};
 ...
 * @summary Change the current song to this
 */
export const queuesNextSong = <TData = AxiosResponse<void>>(
    queueId: string,
    songId: string,
    options?: AxiosRequestConfig
): Promise<TData> => {
    return axios.post(
        `/api/queues/${queueId}/queue/${songId}/next`,
        undefined,
        options
    );
};
...
export const songsSearch = <
    TData = AxiosResponse<PaginatedSearchResponseItemCursor>
>(
...
export type QueuesLikeSongResult = AxiosResponse<void>;
export type QueuesNextSongResult = AxiosResponse<void>;
