<script lang="ts">
    ...
    async function signin(e: SubmitEvent) {
        ...
        if (!signinData.username) {
            error({
                _tag: 'usernameRequired',
                msg: $_('login.signinForm.errors.usernameRequired')
            });
            return;
        }
        ...
        if (!signinData.password) {
            error({
                _tag: 'passwordRequired',
                msg: $_('login.signinForm.errors.passwordRequired')
            });
            return;
        }
    ...
    async function signup(e: SubmitEvent) {
        ...
        if (!signupData.name) {
            error({
                _tag: 'nameRequired',
                msg: $_('login.signupForm.errors.usernameRequired')
            });
            return;
        }
        ...
        if (!signupData.password) {
            error({
                _tag: 'passwordRequired',
                msg: $_('login.signupForm.errors.passwordRequired')
            });
            return;
        }
...
<main class="flex flex-col gap-9 sm:flex-row">
    <Form color="red" onsubmit={signin}>
        <TextInput
            ...
            error={(!signinData.username &&
                $_('login.signinForm.errors.usernameRequired')) ||
                null}
        />
        <TextInput
            ...
            error={(!signinData.password &&
                $_('login.signinForm.errors.passwordRequired')) ||
                null}
        />
    ...
    <Form color="blue" onsubmit={signup}>
        <TextInput
            ...
            error={(!signupData.name &&
                $_('login.signupForm.errors.usernameRequired')) ||
                null}
        />
        <TextInput
            ...
            error={(!signupData.password &&
                $_('login.signupForm.errors.passwordRequired')) ||
                null}
        />
        <TextInput
